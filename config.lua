...
-- YOU CAN CONFIGURE EVERYTHING, CURRENT LINKS TO IMAGES AND WAYPOINT COORDINATES ARE FOR DEMO PURPOSES
...
Config.Missions = {
    ...
    },
    {
        ...
        image = "https://lh5.googleusercontent.com/dNaW-Jn5a7xnHQzujQbOUvhb79jbz-TCi1QUDtpQCIdXkjY5FY4W2-u4xXI-gOnemaSZFZH1PUdgfYRyCfkkosOryDQc5PeOx-VWVHNWnkwIq5rvKzvoMfZinmNSFVZgh97uw_cLUeyZtRsgPfwA1cY",
...
-- Store content (by default leads to PIXLY store, if you will keep it and integrate NFTconnect you will get 50% of all sales https://github.com/pixlygames/nftconnect)
Config.Store = {
    {
        id = 1,
        title = "Vehicle Shop",
...
Config.Announcements = {
    {
        ...
        date = "2025-05-01",
        description = "Reach out in dicord https://discord.com/invite/7dr9m5AFCF.",
